...
echo " ** <filespec> out-of-date **";exit 1
echo " ** <filespec> out-of-date **";exit 1
echo " ** ClearTerrSegs.sh out-of-date **;exit 1"
...
printf "%s\n" "-- * ClearTerrSegs.psq/sql - export territory segments to Terr264Streetstxt."  > SQLTemp.sql
...
printf "%s\n" ".quit"  >> SQLTemp.sql
printf "%s\n" "-- * END ClearTerrSegss.sql;"  >> SQLTemp.sql

#endprocbody - changed from end proc body 12/3/21 for awk reversal.
# jumpto references removed 9/6/21.
sqlite3 < SQLTemp.sql
printf "%s\n" "  ClearTerrSegs complete."
